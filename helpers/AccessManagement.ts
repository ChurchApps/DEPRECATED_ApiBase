...
export interface UserInterface { id?: number, email?: string, authGuid?: string, firstName?: string, lastName: string, registrationDate?: Date, lastLogin?: Date, password?: string }